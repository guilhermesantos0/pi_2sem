        ...
        <div className="Localizacao">
            ...
            <div className="LocalizacaoContent">
                <div className="col-md-12">
                    <h5 className="text-center endereco"> Venha conhecer nosso projeto, a Usina Eco-Cultural fica localizada na  <br/> <strong>R. Breno Ferraz do Amaral, 415 - Cursino, São Paulo - SP, 04124-020</strong> </h5>
                </div>
                ...
                <div col-md-12>
                    <div className="rotas">
                        ...
                        <div className="subway" style={{marginTop: '25px'}}>
                            <h5 className="font-bold text-uppercase title-rotas"><b>Saiba como chegar de mêtro</b></h5>
